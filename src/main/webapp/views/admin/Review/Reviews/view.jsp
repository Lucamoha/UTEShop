...
<section class="row">
	<div class="col-md-10 offset-md-1 mt-4">
		<div class="card shadow-lg border-0 rounded-4">
			<div
				class="card-header bg-gradient text-white d-flex align-items-center justify-content-between p-3 rounded-top-4"
				style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
				<div class="d-flex align-items-center">
					<i class="fa fa-star fa-2x me-3 text-warning"></i>
					<h3 class="mb-0 fw-bold">Chi Tiết Đánh Giá</h3>
				</div>
				<span class="badge bg-light text-dark fs-6">Đánh Giá
					#${review.id}</span>
			</div>
			<div class="card-body p-4 bg-gradient"
				...
				<div class="row g-4">
					<div class="col-md-6">
						<div
							class="info-card h-100 p-3 border rounded-3 bg-white shadow-sm">
					...
					<div class="col-md-6">
						<div
							class="info-card h-100 p-3 border rounded-3 bg-white shadow-sm">
							<h6 class="text-muted mb-3">
								<i class="fa fa-box me-2"></i>Thông Tin Sản Phẩm
							</h6>
							<div class="mb-3">
				...
				<div class="row g-4 mt-3">
					<div class="col-md-12">
						<div class="info-card p-3 border rounded-3 bg-white shadow-sm">
							<h6 class="text-muted mb-3">
								<i class="fa fa-star me-2"></i>Chi Tiết Đánh Giá
							</h6>
							<div class="row">
								...
								<div class="col-md-3 mb-3">
									...
									<p
										class="fs-5 fw-medium ${review.status ? 'text-success' : 'text-danger'}">${review.status ? 'Hiện thị' : 'Ẩn'}</p>
								</div>
							</div>
							<div class="mb-3">
