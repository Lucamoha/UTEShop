	...
	<div class="card">
		...
		<div class="card-body">
			...
			<div class="row mt-2 mb-3">
				<div class="col-md-6">
					<form
						action="${pageContext.request.contextPath}/admin/Branch/Branches/searchpaginated"
						method="get">
						<div class="input-group">
							<input type="text" class="form-control" name="searchKeyword"
								placeholder="Nhập từ khóa tên để tìm"
								value="${searchKeyword}">
				...
				<div class="col-md-6">
					<div class="float-end">
						<a class="btn btn-outline-success"
							href="${pageContext.request.contextPath}/admin/Branch/Branches/saveOrUpdate"><i
							class="bi bi-plus-circle"></i> Thêm Chi Nhánh</a>
					</div>
				</div>
			</div>
				...
				<nav aria-label="Page navigation">
					<ul class="pagination justify-content-center">
						...
						<li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
							<a class="page-link"
							href="${pageContext.request.contextPath}/admin/Branch/Branches/searchpaginated?page=1&size=${size}">First</a>
						</li>

						<c:forEach begin="1" end="${totalPages}" var="i">
							<li class="page-item ${i == currentPage ? 'active' : ''}"><a
								class="page-link"
								href="${pageContext.request.contextPath}/admin/Branch/Branches/searchpaginated?page=${i}&size=${size}">
									${i} </a></li>
						</c:forEach>
						...
						<li
							...
							<a class="page-link"
							href="${pageContext.request.contextPath}/admin/Branch/Branches/searchpaginated?page=${totalPages}&size=${size}">Last</a>
						</li>
					</ul>
				</nav>
			</c:if>
