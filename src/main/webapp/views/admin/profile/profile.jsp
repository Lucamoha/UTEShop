    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="${pageContext.request.contextPath}/admin/profile" id="profileForm">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="tel" class="form-control" id="phone" name="phone" 
                                       value="${user.phone}" placeholder="Nhập số điện thoại (10-11 số)">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <div class="avatar avatar-xl">
                            <img src="${pageContext.request.contextPath}/templates/admin/img/profile.jpg" 
