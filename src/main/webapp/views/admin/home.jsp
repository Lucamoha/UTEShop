...
<div
	...
	<div class="ms-md-auto py-2 py-md-0">
		<a href="#" class="btn btn-label-info btn-round me-2">Manage</a> <a
			href="#" class="btn btn-primary btn-round">Add Customer</a>
	</div>
</div>
<div class="row">
			...
			<div class="card-header">
				<div class="card-head-row">
					...
					<div class="card-tools">
						...
						</a> <a href="#" class="btn btn-label-info btn-round btn-sm"> <span
							class="btn-label"> <i class="fa fa-print"></i>
						</span> Print
						</a>
					</div>
				</div>
	...
	<div class="col-md-12">
		<div class="card card-round">
			<div class="card-header">
				...
				<p class="card-category">Map of the distribution of users around
					the world</p>
			</div>
			<div class="card-body">
				<div class="row">
